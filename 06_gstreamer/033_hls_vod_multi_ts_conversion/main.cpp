...
int main(int argc, char* argv[]) {
    ...
    std::cout << std::endl;
    std::cout << "===== Lesson 36 Multi MP4 to HLS VOD TS Conversion Test =====" << std::endl;
    std::cout << "Create playback sessions for the last 10 minutes, create HLS VOD session directories, write index.m3u8, then convert every MP4 segment plan to TS files." << std::endl;
    std::cout << "This step converts all HLS segment plans. Offset/duration trimming is not applied yet." << std::endl;
