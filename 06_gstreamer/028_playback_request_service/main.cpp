...
int main(int argc, char* argv[]) {
    ...
    std::cout << std::endl;
    std::cout << "===== Lesson 31 PlaybackService Test =====" << std::endl;
    std::cout << "Create playback sessions for the last 10 minutes." << std::endl;
    std::cout << "This step only creates playback metadata, not HLS files yet." << std::endl;
