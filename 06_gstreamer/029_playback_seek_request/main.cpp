...
int main(int argc, char* argv[]) {
    ...
    std::cout << std::endl;
    std::cout << "===== Lesson 32 PlaybackService + Seek Test =====" << std::endl;
    std::cout << "Create playback sessions for the last 10 minutes, then test seek inside each session." << std::endl;
    std::cout << "This step creates playback metadata and calculates seek offsets. HLS files are not generated yet." << std::endl;
