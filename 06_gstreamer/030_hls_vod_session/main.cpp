...
int main(int argc, char* argv[]) {
    ...
    std::cout << std::endl;
    std::cout << "===== Lesson 33 HLS VOD Session Test =====" << std::endl;
    std::cout << "Create playback sessions for the last 10 minutes, test seek, then create HLS VOD session directories." << std::endl;
    std::cout << "This step creates HLS session metadata and cache directories. TS files and index.m3u8 are not generated yet." << std::endl;
